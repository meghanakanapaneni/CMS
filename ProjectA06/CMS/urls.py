...
urlpatterns = [
    ...
    url(r'^trackaca1',views.trackaca1,name = "trackaca1"),
...
#    url(r'^teaching/IR',views.teachingcourse1,name = 'IR'),
 #   url(r'^teaching/PC',views.teachingcourse2,name = 'PC'),
    ...
    url(r'^facultyanswerqueries',views.facultyanswerqueries,name  = "facultyanswerqueries"),
    ...
    url(r'^adminupdateattendence',views.adminupdateattendence,name="adminupdateattendence"),
    url(r'^logout',views.logout,name="logout"),

    url(r'^facultyupdateclasses',views.facultyupdateclasses,name="facultyupdateclasses"),
